...
<div class="media">
<div class="media-body">
<h4 class="media-heading"><?php echo Yii::t("app", "Codeine Website Reviewer") ?></h4>
<img class="media-object marketing-img pull-left" src="<?php echo Yii::app() -> getBaseUrl(true) ?>/img/review.png" alt="<?php echo Yii::t("app", "Codeine Website Reviewer") ?>" />
