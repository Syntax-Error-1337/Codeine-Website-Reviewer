...
$(document).ready(function(){
    ...
    <?php /*if($showPageSpeedInsightDownloadForm): ?>
    showPageSpeedForm();
    <?php endif; */ ?>
    ...
    <?php if(Utils::v($psiConfig, "show")): ?>
        WrPsi(<?php echo CJSON::encode(array(
            ...
            'runInstantly'=>Utils::v($psiConfig, "runInstantly"),
...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <?php if(Utils::v($psiConfig, "show")): ?>
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <label class="radio">
                        <input type="radio" name="psi__strategy" value="desktop"<?php echo Utils::isPsiActive("device", "desktop") ? " checked" : null; ?>>
                        <?php echo Yii::t("app", "Desktop"); ?>
                    </label>
                    <label class="radio">
                        <input type="radio" name="psi__strategy" value="mobile"<?php echo Utils::isPsiActive("device", "mobile") ?  " checked": null; ?>>
                ...
                <div class="span6">
                    ...
                    <label class="checkbox">
                        <input type="checkbox" data-psi-category="performance" value="performance"<?php echo Utils::isPsiActive("categories", "performance") ? " checked" : null; ?>>
                        <?php echo Yii::t("app", "Performance"); ?>
                    </label>

                    <label class="checkbox">
                        <input type="checkbox"  data-psi-category="accessibility" value="accessibility"<?php echo Utils::isPsiActive("categories", "accessibility") ? " checked" : null; ?>>
                        <?php echo Yii::t("app", "Accessibility"); ?>
                    </label>

                    <label class="checkbox">
                        <input type="checkbox" data-psi-category="best-practices" value="best-practices"<?php echo Utils::isPsiActive("categories", "best-practices") ? " checked" : null; ?>>
                        <?php echo Yii::t("app", "Best Practices"); ?>
                    </label>

                    <label class="checkbox">
                        <input type="checkbox" data-psi-category="seo" value="seo"<?php echo Utils::isPsiActive("categories", "seo") ? " checked" : null; ?>>
                        <?php echo Yii::t("app", "SEO"); ?>
                    </label>

                    <label class="checkbox">
                        <input type="checkbox" data-psi-category="pwa" value="pwa"<?php echo Utils::isPsiActive("categories", "pwa") ? " checked" : null; ?>>
        ...
        <?php /* if(!$hidePageSpeedInsightBlock): ?>
            <h4 id="page_speed"><?php echo Yii::t("app", "Page speed") ?></h4>
            <hr>
